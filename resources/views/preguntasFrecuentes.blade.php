...
@section('content')
  ...
  <p><b>-¿Hay algún requisito que se deba cumplir para acceder al servicio?</b></p>
  <p>Podrán participar todas las personas mayores a 18 años. Deben tener:</p>
  <p>a) Documento de identidad </p>
  <p>b) Buena onda </p>
  ...
  <p>1) Complete el formulario de <a href="?pagina=register" target="_blank">registro</a> en la página de inicio </p>
  ...
  <p>5) Ya se encuentra habilitado para navegar en nuestra plataforma y disfutar de nuestro servicio.
  <p><b>-¿Puedo calificar al acompañante? </b></p>
  <p>Nuestra plataforma cuenta con una sección donde podrás puntuar del 1 al 10 a la persona guía que te acompaño. De esta manera se actualiza dariamente el RANKING del mejor acompañante.</p>
  <p><b>-¿Qué sucede si la persona no se presenta en el punto de encuentro? </b></p>
  <p>No te preocupes siempre hay un plan B armado para que cerca de tu zona puedas sumarte a un tour organizado para otra persona.</p>
